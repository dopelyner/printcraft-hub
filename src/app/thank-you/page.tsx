...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className='relative lg:min-h-full'>
      <div className='hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lgpr-4 xl: pr-12:'>
        <Image
          fill
      ...
      <div>
        <div className=' mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:p-32 xl:gap-x-24'>
          <div className='lg:col-start-2'>
            ...
            {order.isPaid ? (
              <p className='mt-2 text-base text-muted-foreground'>
                ...
                download. We&apos;ve sent yuor receipt and order details to{' '}
              ...
              <p className='mt-2 text-base text-muted-foreground'>
                We appreciate your order, and we&apos;re currently proccessing
